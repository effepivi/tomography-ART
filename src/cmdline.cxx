/*
  ...
  gengetopt --input=myART.ggo --include-getopt 
...
const char *gengetopt_args_info_purpose = "C++ code to reconstruct X-ray tomographic data using the algebraic\nreconstruction technique (ART). It is an iterative reconstruction algorithm.";

const char *gengetopt_args_info_usage = "Usage: myART [OPTIONS]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -r, --reference_CT=STRING     Reference CT slice",
  "  -s, --reference_sinogram=STRING\n                                Input sinogram",
  "  -o, --reconstruction=STRING   Output reconstructed image",
  "  -i, --iterations=INT          Number of iterations of the ART algorithm",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->reference_CT_given = 0 ;
  args_info->reference_sinogram_given = 0 ;
  args_info->reconstruction_given = 0 ;
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->reference_CT_arg = NULL;
  args_info->reference_CT_orig = NULL;
  args_info->reference_sinogram_arg = NULL;
  args_info->reference_sinogram_orig = NULL;
  args_info->reconstruction_arg = NULL;
  args_info->reconstruction_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->reference_CT_help = gengetopt_args_info_help[2] ;
  args_info->reference_sinogram_help = gengetopt_args_info_help[3] ;
  args_info->reconstruction_help = gengetopt_args_info_help[4] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->reference_CT_arg));
  free_string_field (&(args_info->reference_CT_orig));
  free_string_field (&(args_info->reference_sinogram_arg));
  free_string_field (&(args_info->reference_sinogram_orig));
  free_string_field (&(args_info->reconstruction_arg));
  free_string_field (&(args_info->reconstruction_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->reference_CT_given)
    write_into_file(outfile, "reference_CT", args_info->reference_CT_orig, 0);
  if (args_info->reference_sinogram_given)
    write_into_file(outfile, "reference_sinogram", args_info->reference_sinogram_orig, 0);
  if (args_info->reconstruction_given)
    write_into_file(outfile, "reconstruction", args_info->reconstruction_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->reference_sinogram_given)
    {
      fprintf (stderr, "%s: '--reference_sinogram' ('-s') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  
  if (! args_info->iterations_given)
    {
      fprintf (stderr, "%s: '--iterations' ('-i') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      static struct option long_options[] = {
        { "help",	0, NULL, 'h' },
        { "version",	0, NULL, 'V' },
        { "reference_CT",	1, NULL, 'r' },
        { "reference_sinogram",	1, NULL, 's' },
        { "reconstruction",	1, NULL, 'o' },
        { "iterations",	1, NULL, 'i' },
        { 0,  0, 0, 0 }
      };
      ...
      c = custom_getopt_long (argc, argv, "hVr:s:o:i:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'r':	/* Reference CT slice.  */
        
        
          if (update_arg( (void *)&(args_info->reference_CT_arg), 
               &(args_info->reference_CT_orig), &(args_info->reference_CT_given),
              &(local_args_info.reference_CT_given), optarg, 0, 0, ARG_STRING,
          ...
          break;
        case 's':	/* Input sinogram.  */
        
        
          if (update_arg( (void *)&(args_info->reference_sinogram_arg), 
               &(args_info->reference_sinogram_orig), &(args_info->reference_sinogram_given),
              &(local_args_info.reference_sinogram_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "reference_sinogram", 's',
              additional_error))
            goto failure;
        
          break;
        case 'o':	/* Output reconstructed image.  */
        
        
          if (update_arg( (void *)&(args_info->reconstruction_arg), 
               &(args_info->reconstruction_orig), &(args_info->reconstruction_given),
              &(local_args_info.reconstruction_given), optarg, 0, 0, ARG_STRING,
              check_ambiguity, override, 0, 0,
              "reconstruction", 'o',
              additional_error))
            goto failure;
          ...
          break;
        case 'i':	/* Number of iterations of the ART algorithm.  */
        
        
          if (update_arg( (void *)&(args_info->iterations_arg), 
               &(args_info->iterations_orig), &(args_info->iterations_given),
              &(local_args_info.iterations_given), optarg, 0, 0, ARG_INT,
              check_ambiguity, override, 0, 0,
              "iterations", 'i',
              additional_error))
            goto failure;
